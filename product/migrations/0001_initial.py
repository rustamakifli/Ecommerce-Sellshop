    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(blank=True, default=1, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='product_product_version', to='product.product')),
                ('property', models.ManyToManyField(blank=True, to='product.PropertyValues')),
            ],
            options={
